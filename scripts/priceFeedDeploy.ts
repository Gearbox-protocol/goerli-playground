...
import { AbstractDeployer, ChainlinkSuffix } from "./support";
import { ChainlinkProgressKey } from "./support/ProgressTracker";

/**
 * This script deploys chainlink price feed that will be synced with mainnet
 */
class PriceFeedDeployer extends AbstractDeployer {
...
new PriceFeedDeployer().exec().catch(console.log);

...
describe("Curve mocks tests", async function () {
    ...
    it("Curve stETH mock test", async function () {
        ...
        await steCRV.add_liquidity([WAD.mul(100), WAD.mul(100)], WAD.mul(199), {value: WAD.mul(100)})

        expect(await steCRV_token.balanceOf(deployer.address)).to.be.gt(WAD.mul(199))
        ...
        await steCRV.remove_liquidity_imbalance([WAD, WAD.mul(2)], WAD.mul(16).div(10))
        ...
        expect(steCRV_balance_before.sub(steCRV_balance_after)).to.be.lt(WAD.mul(16).div(10))

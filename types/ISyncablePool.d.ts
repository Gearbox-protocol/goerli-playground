...
interface ISyncablePoolInterface extends ethers.utils.Interface {
  functions: {
    "sync(uint256,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  };
...
export class ISyncablePool extends BaseContract {
  ...
  interface: ISyncablePoolInterface;

...
interface ConvexPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ConvexPoolFactory extends BaseContract {
  ...
  interface: ConvexPoolFactoryInterface;

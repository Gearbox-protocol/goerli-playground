...
interface ChainlinkPriceFeedInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mainnetOracle()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mainnetOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ChainlinkPriceFeed extends BaseContract {
  ...
  functions: {
    ...
    mainnetOracle(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    mainnetOracle(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    mainnetOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;
